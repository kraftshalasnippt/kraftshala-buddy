        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(url('admin_user')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="radio-inline"><input style="width:1.2em;height:1.2em;" type="radio" id="role" class="form-control" name="role" value="CL" required>CL</label>
                            </div>
                        </div>
                        <div class="form-group">
